  ...
  return (
    <div className="min-h-screen bg-parchment text-ink font-sans font-light flex items-center justify-center px-5 py-12">
      ...
      <div className="relative z-10 max-w-[560px] text-center">
        ...
        <h1 className="font-fraunces font-light italic text-[64px] md:text-[88px] leading-[0.95] tracking-[-0.03em] mb-8">
          Det link ledte<br />ingen steder hen.
        </h1>
        <p className="text-[17px] leading-[1.6] text-stone mb-10">
          Linket er enten forkert, eller profilen er blevet slettet. Tag testen igen for at få en ny profil.
        </p>
        <Link
          href="/tankeprofil"
