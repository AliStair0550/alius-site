...
function BouncingCircle() {
  ...
  return (
    <div className="absolute right-[4%] top-1/2 -translate-y-1/2 w-[200px] h-[200px] md:w-[400px] md:h-[400px] z-0">
      <div
        ref={circleRef}
        className="rounded-full opacity-15 will-change-transform"
        style={{
