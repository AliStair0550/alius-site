...
const SPECS: SeriesSpec[] = [
  ...
  },
  {
    ...
    check: {
      ...
      pick: { dim: "VALUTA", codes: ["USD", "SEK", "NOK", "GBP", "PLN"] },
  ...
  },
  {
    ...
    katalogNr: 10,
    navn: "Effektiv rente, 30-årig realkredit",
    katalogKandidat: "Nationalbanken PX-Web",
  ...
  },
  {
    id: "nbdk.rente.destr",
    katalogNr: 9,
    navn: "DESTR referencerente (kandidat-erstatning for CIBOR)",
    katalogKandidat: "ikke i kataloget",
    check: {
      kind: "dst", tableId: "DNRENTD",
      pick: { dim: "INSTRUMENT", codes: ["DESNAA"] },
      fixed: [{ code: "LAND", values: ["DK"] }, { code: "OPGOER", values: ["E"] }],
    },
  },
  {
    id: "eds.el.dayahead",
  ...
  },
  {
    id: "eds.el.elspot",
    katalogNr: 5,
    navn: "Elpris, historik før okt. 2025",
